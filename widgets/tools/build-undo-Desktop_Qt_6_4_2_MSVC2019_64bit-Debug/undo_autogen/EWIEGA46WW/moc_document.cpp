...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Document_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Document_t qt_meta_stringdata_Document = {
    {
        QT_MOC_LITERAL(0, 8),  // "Document"
        QT_MOC_LITERAL(9, 19),  // "currentShapeChanged"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 9)   // "shapeName"
    },
    "Document",
    "currentShapeChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_Document[] = {
...
Q_CONSTINIT const QMetaObject Document::staticMetaObject = { {
    ...
    qt_meta_stringdata_Document.offsetsAndSizes,
...
void Document::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->currentShapeChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Document::currentShapeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
